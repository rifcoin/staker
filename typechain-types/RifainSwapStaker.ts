...
export interface RifainSwapStakerInterface extends utils.Interface {
  functions: {
...
export interface RifainSwapStaker extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RifainSwapStakerInterface;
