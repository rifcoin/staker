...
export interface IRifainSwapStateInterface extends utils.Interface {
  functions: {
    "disponible()": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "disponible", data: BytesLike): Result;
...
export interface IRifainSwapState extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IRifainSwapStateInterface;
  ...
  functions: {
    disponible(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    disponible(overrides?: CallOverrides): Promise<PopulatedTransaction>;
