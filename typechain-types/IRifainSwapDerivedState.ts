...
export interface IRifainSwapDerivedStateInterface extends utils.Interface {
  functions: {
...
export interface IRifainSwapDerivedState extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IRifainSwapDerivedStateInterface;
