...
export interface IRifainSwapStakerInterface extends utils.Interface {
  functions: {
...
export interface IRifainSwapStaker extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IRifainSwapStakerInterface;
