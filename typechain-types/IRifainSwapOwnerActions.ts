...
export interface IRifainSwapOwnerActionsInterface extends utils.Interface {
  functions: {
...
export interface IRifainSwapOwnerActions extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IRifainSwapOwnerActionsInterface;
