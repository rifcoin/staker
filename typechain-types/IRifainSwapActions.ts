...
export interface IRifainSwapActionsInterface extends utils.Interface {
  functions: {
...
export interface IRifainSwapActions extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IRifainSwapActionsInterface;
